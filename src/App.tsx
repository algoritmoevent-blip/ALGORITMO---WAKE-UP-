  ...
  return (
    <section className="section-padding relative overflow-hidden">
      <div className="absolute inset-0">
        <img
          src="https://images.pexels.com/photos/1763199/pexels-photo-1763199.jpeg"
          alt="Mountain landscape"
          className="w-full h-full object-cover opacity-15"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-dark via-dark/80 to-dark/60" />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-rose/10 rounded-full blur-[80px]" />
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-teal/10 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-2 text-sand text-xl mb-6">
...
function Info() {
  const infos = [
    ...
    { icon: '19:00', text: 'Apertura ore 19:00' },
    { icon: 'LOW.LINE', text: 'garden room start' },
    { icon: 'LIMITED', text: 'Capienza limitata' },
    { icon: 'PARKING', text: 'Ampio parcheggio' },
    { icon: 'LATE', text: '19:00 → late' },
  ];
  ...
  return (
    <footer className="py-12 bg-dark border-t border-rose/10">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        />
        <p className="font-display text-3xl tracking-wider text-white mb-8">
          ALGORITMO
        </p>
